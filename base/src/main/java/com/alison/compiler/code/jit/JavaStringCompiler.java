package com.alison.compiler.code.jit;
...
public class JavaStringCompiler {
	...
	public Class<?> loadClassByComplie(String fileName,String className,String source) throws IOException, ClassNotFoundException {
