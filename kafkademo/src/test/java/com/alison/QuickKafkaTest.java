...
public class QuickKafkaTest {
    ...
    public void testAutoCommit() throws Exception {
        ...
        containerProps.setMessageListener(new MessageListener<String, String>() {
            ...
            public void onMessage(ConsumerRecord<String, String> message) {
                log.info("======> message: {} -- {} -- {}", message.topic(), message.key(), message.value());
                latch.countDown();
            }
        });
    ...
    private Map<String, Object> consumerProps() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "11.11.1.108:9092");
    ...
    private Map<String, Object> senderProps() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "11.11.1.108:9092");
