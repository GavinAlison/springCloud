...
public class FlinkSql03 {
    ...
    public static final String CSV_TABLE_SOURCE_DDL = "" +
            ...
            ") WITH (\n" +
            " 'connector' = 'filesystem', -- 指定连接类型\n" +
            " 'path' = 'file:///D:\\zuidaima\\UserBehavior.csv',-- 目录 \n" +
            " 'format' = 'csv', -- 文件格式 \n" +
