...
public class FlinkSql05 {
    ...
    public static final String KAFKA_TABLE_SOURCE_DDL_01 = "" +
            ...
            "    'topic' = 'unBoundedJoin01_t1', -- 之前创建的topic \n" +
            "    'properties.group.id' = 'flink-test-0', -- 消费者组，相关概念可自行百度\n" +
            "    'scan.startup.mode' = 'latest-offset',  --指定从最早消费\n" +
            "    'properties.bootstrap.servers' = '11.11.1.108:9092',  -- broker地址\n" +
            "    'format' = 'csv'  -- csv格式，和topic中的消息格式保持一致\n" +
            ")";
    ...
    public static final String KAFKA_TABLE_SOURCE_DDL_02 = "" +
            ...
            ") WITH (\n" +
            "    'connector' = 'kafka',  -- 指定连接类型是kafka\n" +
            "    'topic' = 'unBoundedJoin01_t2', -- 之前创建的topic \n" +
            "    'properties.group.id' = 'flink-test-0', -- 消费者组，相关概念可自行百度\n" +
            "    'scan.startup.mode' = 'latest-offset',  --指定从最早消费\n" +
            "    'properties.bootstrap.servers' = '11.11.1.108:9092',  -- broker地址\n" +
            "    'format' = 'csv'  -- csv格式，和topic中的消息格式保持一致\n" +
    ...
    public static final String KAFKA_TABLE_SOURCE_DDL_03 = "" +
            ...
            ") WITH (\n" +
            "    'connector' = 'kafka',  -- 指定连接类型是kafka\n" +
            "    'topic' = 'timeIntervalJoin_01', -- 之前创建的topic \n" +
            "    'properties.group.id' = 'flink-test-0', -- 消费者组，相关概念可自行百度\n" +
            "    'startup-mode' = 'latest-offset',  --指定从最早消费\n" +
            "    'properties.bootstrap.servers' = '11.11.1.108:9092',  -- broker地址\n" +
            "    'format' = 'csv'  -- csv格式，和topic中的消息格式保持一致\n" +
            ")";
    ...
    public static final String KAFKA_TABLE_SOURCE_DDL_04 = "" +
            ...
            "    'topic' = 'timeIntervalJoin_02', -- 之前创建的topic \n" +
            "    'properties.group.id' = 'flink-test-0', -- 消费者组，相关概念可自行百度\n" +
            "    'scan.startup.mode' = 'latest-offset',  --指定从最早消费\n" +
            "    'properties.bootstrap.servers' = '11.11.1.108:9092',  -- broker地址\n" +
            "    'format' = 'csv'  -- csv格式，和topic中的消息格式保持一致\n" +
